...
آية تطبيق macOS مستقل ومفتوح المصدر يعمل دون اتصال لعرض آيات القرآن الكريم،
ودعم مجموعات الحفظ، وحساب أوقات الصلاة والتنبيه بها داخل التطبيق.
...
Ayah 1.0.0 is an independent, open-source, fully offline macOS app for Quran
verse display, memorization sets, and local prayer-time calculation and alerts.
