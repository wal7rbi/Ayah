...
**الحالة: الإصدار 1.0.3 منشور.** يتوفر آية كتطبيق مفتوح المصدر وغير موثّق
...
- عرض دوري  لآيات القرآن، مع إمكانية تحديد مدة التكرار وعدد الآيات
...
الإصدار 1.0.3 نسخة لمعالجات Intel من معمارية `x86_64`.

## تثبيت التطبيق

يُوزّع آية 1.0.3 مباشرة في الملف `Ayah-1.0.3-macOS-arm64.dmg`. التطبيق
...
[![تنزيل آية لنظام macOS](docs/assets/download-macos.svg)](https://github.com/wal7rbi/Ayah/releases/latest/download/Ayah-1.0.3-macOS-arm64.dmg)
...
```sh
shasum -a 256 -c Ayah-1.0.3-macOS-arm64.dmg.sha256
```
