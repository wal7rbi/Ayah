...
**الحالة: الإصدار 1.0.4 منشور.** يتوفر آية كتطبيق مفتوح المصدر وغير موثّق
...
الإصدار 1.0.4 نسخة لمعالجات Intel من معمارية `x86_64`.

## تثبيت التطبيق

يُوزّع آية 1.0.4 مباشرة في الملف `Ayah-1.0.4-macOS-arm64.dmg`. التطبيق
...
[![تنزيل آية لنظام macOS](docs/assets/download-macos.svg)](https://github.com/wal7rbi/Ayah/releases/latest/download/Ayah-1.0.4-macOS-arm64.dmg)
...
```sh
shasum -a 256 -c Ayah-1.0.4-macOS-arm64.dmg.sha256
```
